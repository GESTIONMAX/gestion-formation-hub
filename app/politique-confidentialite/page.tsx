...
export const metadata: Metadata = {
  title: 'GestionMax Formation Hub - Politique de Confidentialité',
  description: 'Politique de confidentialité et protection des données personnelles de GestionMax Formation Hub',
};
