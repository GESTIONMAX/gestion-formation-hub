...
export const metadata: Metadata = {
  title: 'GestionMax Formation Hub - Accessibilité',
  description: 'Déclaration d\'accessibilité et accompagnement des personnes en situation de handicap',
};
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="mt-4 text-center">
            <Link href="/contact" className="inline-flex items-center justify-center bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="ml-4">
            ...
            <p>Formulaire de contact : <Link href="/contact" className="text-blue-600 hover:underline">Contactez-nous</Link></p>
          </div>
