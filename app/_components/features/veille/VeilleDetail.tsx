...
import { Veille, StatutVeille } from "@/lib/utils/types/veille";
...
const VeilleDetail = ({
  ...
  const saveAvancement = () => {
    ...
    toast.success(`Avancement mis à jour: ${avancementLocal}%`);
  };
  ...
  const saveCommentaire = () => {
    if (nouveauCommentaire.trim()) {
      ...
      toast.success("Le commentaire a été enregistré avec succès");
    }
  };
